...
test.describe('Add Employee - Edge Cases: Special Characters', () => {
    
    test('Scenario 5.1: Employee name with special characters', async ({ App, AppData, page }) => {
        ...
        // Get employee data with special characters
        const employee = AppData.employeeData.employees.specialCharacterNames;

        // Enter employee information with special characters
